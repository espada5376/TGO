...
<div id='cat'>
    ...
    <div class='boss'>
        ...
        <div class='swiper catscroll'>

            <nav class='swiper-wrapper'>  
                <a data-value='' class='swiper-slide' href='#/' data-route='#/'>Tous</a>
                                    <?php foreach ($categories as $categorie): ?>
                <a data-value='<?= htmlspecialchars($categorie['data_route_categorie']) ?>' class='swiper-slide' href='#/<?= htmlspecialchars($categorie['nom_categorie']) ?>' data-route='#/<?= htmlspecialchars($categorie['data_route_categorie']) ?>'><?= htmlspecialchars($categorie['nom_categorie'])  ?></a>
...
<section class='' id='section3'>
    <div class="content"><span class='message'>Aucune annonce trouvé !</span></div>
    <div class="loader"></div>
    <br/>
    <br/>
    <br/>
