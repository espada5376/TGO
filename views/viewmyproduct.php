...
<head>
    ...
    <link rel="stylesheet" href="<?= ASSETS_URL ?>style/viewmyproduct.css?v=<?= filemtime(ASSETS_PATH.'style/viewmyproduct.css') ?>">
    ...
    <script src="<?= ASSETS_URL ?>js/viewmyproduct.js?v=<?= filemtime(ASSETS_PATH.'js/viewmyproduct.js') ?>" defer></script>
