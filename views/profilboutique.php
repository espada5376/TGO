...
<head>
    ...
    <link rel="stylesheet" href="<?= ASSETS_URL ?>style/profilboutique.css?v=<?= filemtime(ASSETS_PATH.'style/profilboutique.css') ?>">
    ...
    <script src="<?= ASSETS_URL ?>js/profilboutique.js?v=<?= filemtime(ASSETS_PATH.'js/profilboutique.js') ?>" defer></script>
