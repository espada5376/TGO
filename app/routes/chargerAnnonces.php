...
require_once __DIR__ . '/../models/trustscores.php';
require_once __DIR__ . '/../controllers/trustscore.php';
...
listeAnnonce($conn);
updateAnnonceStats($conn);
trustscoreController($conn);
//longPollNotifications($conn, $tarifsRetrait);
